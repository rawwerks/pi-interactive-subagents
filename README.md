...
# or (zmx — no wrapper needed, just have zmx installed)
pi
```

Optional: set `PI_SUBAGENT_MUX=cmux|tmux|zellij|zmx` to force a specific backend.
...
```bash
export PI_SUBAGENT_MUX=cmux   # or tmux, zellij, zmx
```
